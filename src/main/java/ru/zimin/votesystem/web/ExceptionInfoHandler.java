...
import ru.zimin.votesystem.util.ValidationUtil;
import ru.zimin.votesystem.util.exceptions.*;
...
import static ru.zimin.votesystem.util.exceptions.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo handleError(HttpServletRequest req, TooLateForVoteException e) {
    ...
    @ResponseStatus(value = HttpStatus.UNPROCESSABLE_ENTITY)  // 422
    @ExceptionHandler({IllegalRequestDataException.class, MethodArgumentTypeMismatchException.class, HttpMessageNotReadableException.class, DataAccessException.class})
